...
namespace UnitTests
{
    public class CustomerServiceTests
    {
        ...
        public void Given_Customer_When_IsNotOfLegalAge_Then_ShouldThrowException()
        {
            ...
            _customerAgeValidatorMock.Setup(v => v.IsOfLegalAge(customer.BirthDate)).Returns(false);
        ...
        public void Given_Customer_When_IsOfLegalAge_Then_ShouldAddCustomer()
        {
            ...
            _customerAgeValidatorMock.Setup(v => v.IsOfLegalAge(customer.BirthDate)).Returns(true);
